...
export class AuthService {
  ...
  isAdmin(): boolean {
    ...
    const hasUserManagement = 
      flatPermissions.includes('Users.ViewUsers') && 
      flatPermissions.includes('Users.CreateUser') && 
      flatPermissions.includes('Users.UpdateUser');
      
    const hasRoleManagement = 
      flatPermissions.includes('Roles.ViewRoles') && 
      flatPermissions.includes('Roles.CreateRole');
      
    return hasUserManagement && hasRoleManagement;
  }
