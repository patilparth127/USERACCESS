...
export class AccessService {
  ...
  private isAdmin(user: any): boolean {
    ...
    const hasUsersManagement = flatPermissions.includes('Users.CreateUser') && 
                               flatPermissions.includes('Users.UpdateUser') &&
                               flatPermissions.includes('Users.DeleteUser');
                               
    const hasRolesManagement = flatPermissions.includes('Roles.CreateRole') &&
                               flatPermissions.includes('Roles.UpdateRole');
    
    return hasUsersManagement && hasRolesManagement;
  }
